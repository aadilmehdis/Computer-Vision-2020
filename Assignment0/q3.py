...
lower_blue = np.array([20, 120, 20])     ##[R value, G value, B value]
upper_blue = np.array([80, 180, 80])
...
def main():
    frames = apply_chroma_key('./fg.mp4', './bg.mp4')
    convert_frames_to_video(frames, 'final.mp4', 24)
